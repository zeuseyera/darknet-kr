...
| [다크넷](./README.md) | [설치](./1_SeolChi/SeolChi.md) | [욜로](./2_YOLO/yolo.md) | [이미지넷분류](./3_ImageNet_BunRyu/BunRyu.md) | [악몽](./4_AkMong/AkMong.md) | [재사용신경망](./5_RNN/rnn.md) | [다크고](./6_DarkGo/DarkGo.md) | [꼬맹이망](./7_GgoMaengIi/GgoMaengIi.md) | [분류기수련](./8_SuRyeon/SuRyeon.md#CIFAR-10-분류기) |  
| --- | --- | --- | --- | --- | --- | --- | --- | --- |  
...
## [8. CIFAR-10 으로 분류기를 수련한다(Train a Classifier on CIFAR-10)](./8_SuRyeon/SuRyeon.md#CIFAR-10-분류기)
